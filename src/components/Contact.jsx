...
export default function Contact({
  ...
  contactimage = "/connectimage.jpg", // 👈 yaha apna image path de de
}) {
        ...
        <div className="max-w-6xl mx-auto bg-white/6 backdrop-blur-md border border-white/10 rounded-2xl p-4 md:p-8 shadow-xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="flex flex-col justify-between h-full">
                ...
                <div className="mt-4">
                  <div className="overflow-x-auto rounded-md">
                    <table className="w-full table-auto border-collapse text-white min-w-[480px] md:min-w-0">
                      <thead>
                        <tr>
                          <th className="border border-white/60 px-4 py-3 text-left bg-white/6">
                            Particular
                          </th>
                          <th className="border border-white/60 px-4 py-3 text-left bg-white/6">
                            Amount
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td className="border border-white/30 px-4 py-4">
                            Rest on Possession / Registry
                          </td>
              ...
              {/* Bottom: Image card to fill empty space */}
              <div className="mb-17">
                <div className="bg-white/8 border border-white/15 rounded-xl overflow-hidden shadow-lg">
                  <div className="h-32 sm:h-40 md:h-44 lg:h-52 w-full overflow-hidden">
                    <img
                      src={contactimage}
                      alt="Dravyam farm view"
            ...
            {/* RIGHT: Contact Options + Form (same as before) */}
            <div>
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        d="M2 7a2 2 0 012-2h3.6a1 1 0 01.9.55l1.2 2.4a1 1 0 01-.2 1.1L7.5 11a11 11 0 005.5 5.5l1.95-1.95a1 1 0 011.1-.2l2.4 1.2a1 1 0 01.55.9V20a2 2 0 01-2 2H6a2 2 0 01-2-2V7z"
                      />
                    </svg>
                  ...
                  >
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M21 12.5a8.5 8.5 0 10-3.7 6.8L21 21l-2.2-5.7A8.5 8.5 0 0021 12.5z"
                      />
                    </svg>
                  ...
                  >
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M3 8.4v7.2A2.4 2.4 0 005.4 18h13.2A2.4 2.4 0 0021 15.6V8.4M3 8.4L12 13l9-4.6"
                      />
                    </svg>
                  ...
                  <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-3">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          window.open(
                            `https://wa.me/${whatsapp.replace(/\D/g, "")}?text=${txt}`,
                            "_blank"
                          );
                        }}
                    ...
                    {sent && (
                      <div className="text-sm text-emerald-300">
                        Message sent (simulated). We'll contact you soon.
                      </div>
                    )}
                  </form>
                </div>
              ...
              <div className="mt-4 text-white/70 text-sm md:text-base">
                ...
                <p className="mt-2">
                  Or call/WhatsApp anytime for urgent queries — we respond quick.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-white/60">
            © Dravyam Farms — All rights reserved.
          </div>
        </div>
      </div>
    </section>
