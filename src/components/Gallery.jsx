import farmimage from '/src/assets/farmimage1.jpg';
    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto px-6">
                <h1 className="text-4xl font-semibold text-center mx-auto text-white">Our Latest Creations</h1>
                ...
                <div className="flex flex-wrap items-center justify-center mt-12 gap-4 max-w-5xl mx-auto">
                    {/* ---------- IMAGE CARD ---------- */}
                    {[
                        "/src/assets/gallerypic1.jpg",
                          "/src/assets/gallerypic2.jpg",
                            "/src/assets/gallerypic3.jpg",
                              
                                "/src/assets/gallerypic4.jpg",
                                  "/src/assets/gallerypic5.jpg",
                                  "/src/assets/gallerypic1.jpg",
                                    "/src/assets/gallerypic2.jpg",
                                    "/src/assets/gallerypic7.jpg",
                                    "/src/assets/gallerypic8.jpg",
                       
                    ].map((src, i) => (
                        <div key={i} className="relative group rounded-lg overflow-hidden w-56 h-40 md:w-64 md:h-44">
                            <img
                                src={src}
                                alt={`gallery-${i}`}
